...
#find "$DIR" -name "$@" -exec echo "#### " '{}' \; -exec ls -l '{}' \;	# Display directory listings of file argument(s)
find "$DIR" -depth -name "$@" -exec echo -e "\n#### " '{}' \; -exec ls -l '{}' \; -exec file '{}' \;	# Display directory listings and file-type  of file argument(s)
